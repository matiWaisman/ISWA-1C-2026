...
| mbt_21 | $\{x_{m2} \to 0, \text{res}_2 \to \bot\}$ | $\{x_{m1} \to 0, \text{res}_2 \to \bot\}$ |
| mbt_22 | $\{x_{m2} \to 0, \text{res}_2 \to \bot\}$ | $\{x_{m1} \to 0, \text{res}_2 \to 0\}$    |
| mbt_23 | $\{x_{m2} \to 0, \text{res}_2 \to \bot\}$ | $\{x_{m1} \to 0, \text{res}_2 \to 0\}$    |
| mbt_24 | $\{x_{m2} \to 0, \text{res}_2 \to \bot\}$ | $\{x_{m1} \to 0, \text{res}_2 \to 0\}$    |
| m8     | $\{x \to 0, y \to >\}$                    | $\{x \to 0, y \to 0\}$                    |
| m9     | $\{x \to 0, y \to 0\}$                    | $\{x \to 0, y \to 0\}$                    |
| m10    | $\{x \to 0, y \to 0\}$                    | -                                         |
